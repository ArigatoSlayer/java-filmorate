...
(
    ...
    director_id  integer      REFERENCES film_directors (director_id)
);
...
(
    director_id integer     GENERATED ALWAYS BY DEFAULT AS IDENTITY PRIMARY KEY,
    name        varchar     NOT NULL
);

CREATE TABLE IF NOT EXISTS film_directors
(
    film_id     REFERENCES film (film_id)           ON DELETE CASCADE ON UPDATE CASCADE,
    director_id REFERENCES directors (director_id)  ON DELETE CASCADE ON UPDATE CASCADE,
