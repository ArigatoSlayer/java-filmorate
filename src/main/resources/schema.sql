...
users, film, mpa_ratings, genre, film_genre, likes, friends, film_directors, directors, reviews, feed, review_rates CASCADE;
...
(
    ...
    mpa_id       integer      REFERENCES mpa_ratings (mpa_id) ON DELETE CASCADE ON UPDATE CASCADE
);
